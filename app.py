...
MODEL_REPO = "Anujgour47/tourism-package-predictor"
...
DurationOfPitch = st.number_input(
    "Duration of Pitch", min_value=0, value=10
)
...
NumberOfFollowups = st.number_input(
    "Number of Followups", min_value=0, value=1
)
...
NumberOfTrips = st.number_input(
    "Number of Trips", min_value=0, value=1
)
...
if st.button("Predict"):
    ...
    if prediction == 1:
        ...
        st.info("Customer is unlikely to purchase the package.")
